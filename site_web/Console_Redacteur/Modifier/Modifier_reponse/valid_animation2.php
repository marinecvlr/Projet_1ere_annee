...
/**
* \file valid_animation2.php
* \brief Page de confirmation de la modification de la question
* \author Marine CUVELIER
* \version 1.0
* \date 21 juin 2020
*
* Cette page sert uniquement à confirmer visuellement au Rédacteur que le traitement pour modifier une question s'est correctement déroulé.
*/
